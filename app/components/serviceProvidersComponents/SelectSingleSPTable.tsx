...
export default function SelectSingleSPTable(props: any) {
  const { setSelectProviderPopup } = props;
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <div
                        className="dark-button flex items-center justify-center text-gold"
                        onClick={() => {
